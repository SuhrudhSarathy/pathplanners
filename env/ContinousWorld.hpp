#ifndef CONTINOUSWORLD_H
#define CONTINOUSWORLD_H
...
class ContinousWorld{
    public:
        ContinousWorld(float X_ = 10, float Y_ = 10, float obstacle_level_ = 0.1, float start_x = 0, float start_y = 0, float goal_x = 10, float goal_y = 10){
        ...
        void get_status(){
            std::cout << "```ContinousWorld```" << std::endl;
